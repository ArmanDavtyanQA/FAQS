...
const actionBtn =
  "btn-shadow-smooth btn-ghost-edge inline-flex h-10 min-w-[10rem] flex-1 items-center justify-center rounded-xl bg-white px-4 text-[11px] font-medium uppercase tracking-[0.12em] text-[#0a0a0a] transition hover:bg-[#0a0a0a] hover:text-white hover:border-white/10 sm:flex-none sm:min-w-[11rem]";
const actionBtnPrimary =
  "btn-shadow-smooth btn-solid-edge inline-flex h-10 min-w-[10rem] flex-1 items-center justify-center rounded-xl bg-[#0a0a0a] px-4 text-[11px] font-medium uppercase tracking-[0.12em] text-white transition hover:bg-[#2a2a2a] sm:flex-none sm:min-w-[11rem]";
